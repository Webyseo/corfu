...
for skill_file in codex/corfu/SKILL.md claude/corfu/SKILL.md; do
  ...
  require_contains "$skill_file" "Closure Target"
  require_contains "$skill_file" "LOCAL WORKTREE"
  require_contains "$skill_file" "PRODUCT / ROADMAP"
  require_contains "$skill_file" "Product / Roadmap Closure Rules"
  require_contains "$skill_file" "A clean git status is not enough evidence for product-level closure"
  require_contains "$skill_file" "This does not certify product, roadmap, release, or business completeness"
  ...
  require_contains "$skill_file" "product"
  require_contains "$skill_file" "roadmap"
...
require_contains README.md "Closure Target Matters"
require_contains README.md "Corfu separates local closure from product closure"
require_contains README.md "\$corfu"
require_contains README.md "\$corfu product"
require_contains README.md "/corfu"
require_contains README.md "/corfu product"
...
require_contains prompts/usage_prompts.md "\$corfu product"
require_contains prompts/usage_prompts.md "\$corfu roadmap"
...
require_contains docs/workflows.md "Product Readiness Check"
require_contains docs/workflows.md "Do not treat a clean working tree as product completion"
